...
# ---------------------------------------------------------------------------------------
base_info:
  title: Hexrotor的博客 # Site title
  author: Hexrotor # Author name
  url: https://hexrotor.github.io/ # Site url
...
style:
  ...
  avatar: /images/avatar.jpg # avatar of the author

  # Favicon (You can use local image or image external link)
  favicon: https://img.icons8.com/ios-glyphs/30/null/internet-explorer.png # favicon of the site
  ...
  first_screen:
    enable: true
    background_image: # 主页大背景
      light: /images/girl_light.jpeg 
      dark: /images/girl_dark.jpeg # background image of the first screen, use relative path or external link (if your website is in subdirectory, use external link)
    title_color:
      light: "#fff" # first screen title color (light mode)
      dark: "#d1d1b6" # first screen title color (dark mode)
    description: 欢迎来到我的博客<br>我会在这里记录一些生活中的事情 # the title in the middle of the first screen. HTML supported (e.g. svg html code of your logo)
...
social_contact: # social contact icons in the first screen, you can add more by using fontawesome icon names
  enable: true
  links:
    github:  https://github.com/Hexrotor # your GitHub URL
    instagram: # your Instagram URL
    zhihu:  # your ZhiHu URL
    twitter:  # your twitter URL
    bilibili: https://space.bilibili.com/37856989/
    email:  ts_studio@foxmail.com # your email
    # ...... # you can add more
