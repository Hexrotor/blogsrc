...
为什么要降档？某些时候我们需要降档来更好地利用发动机。在跑山时，为了防止刹车过热，我们可以依赖发动机来制动。正常情况下只要不给油，家用车的发动机转速一般在1k以下，所以只要发动机高于这个转速就会有制动效果。根据杠杆原理，挡位越低，发动机制动效果越明显。同样根据杠杆原理，档位越低，发动机输出给轮胎的扭矩越大，在超车时提速更快，所以超车和陡坡常常需要降档。
